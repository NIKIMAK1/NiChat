...
- 💬 **View Chat History**: Press `U` (or another key you assign) to open a scrollable history of all messages.
...
- Does not support displaying F3 system notifications, network open notification.
